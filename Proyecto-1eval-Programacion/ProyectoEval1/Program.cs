    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                // Console.WriteLine(Hash.HashString("Manuel"));
                ...
                Console.WriteLine(Validators.IsValidEmail("dm@d.es"));
                ...
                string s = Utils.ChangeCaptionString("HOla", false);
                Console.WriteLine(s);
                ...
                int minute = 24;
                int second = 50;
                Console.WriteLine(Dates.ConvertDateToString(year, month, day, hour, minute, second));
